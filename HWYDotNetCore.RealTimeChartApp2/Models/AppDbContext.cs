...
public partial class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<TblBlog>(entity =>
        {
            ...
            entity.Property(e => e.BlogAuthor).HasMaxLength(50).IsUnicode(false);
            entity.Property(e => e.BlogContent).HasMaxLength(50).IsUnicode(false);
            entity.Property(e => e.BlogTitle).HasMaxLength(50).IsUnicode(false);
        });
        ...
        modelBuilder.Entity<TblPieChart>(entity =>
        {
            ...
            entity.Property(e => e.PieChartName).HasMaxLength(50).IsUnicode(false);
        ...
        modelBuilder.Entity<TblPizza>(entity =>
        {
            ...
            entity.Property(e => e.Pizza).HasMaxLength(50).IsUnicode(false);
        ...
        modelBuilder.Entity<TblPizzaExtra>(entity =>
        {
            ...
            entity.Property(e => e.PizzaExtraName).HasMaxLength(50).IsUnicode(false);
            entity.Property(e => e.Price).HasColumnType("decimal(18, 2)");
        });
        ...
        modelBuilder.Entity<TblPizzaOrder>(entity =>
        {
            ...
            entity.Property(e => e.PizzaOrderInvoiceNo).HasMaxLength(50).IsUnicode(false);
